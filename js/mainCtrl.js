...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  //*remember, that method should be expecting an artist name. The artist name is coming from the input box on index.html, head over 
  //there and check if that input box is tied to any specific model we could use.
  ...
  //But unfortunately that's not what ng-grid is expecting. What you need to do now is sort the data you got back to be an object 
